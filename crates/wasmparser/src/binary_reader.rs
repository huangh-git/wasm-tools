...
impl<'a> BinaryReader<'a> {
        ...
        T: VisitOperator<'a>,
    {
        ...
        Ok(match code {
            ...
            0xe2 => visitor.visit_f32_msload(self.read_memarg(2)?),
            0xe3 => visitor.visit_f64_msload(self.read_memarg(3)?),
            0xe4 => visitor.visit_memref_msload(self.read_memarg(2)?),
            0xe5 => visitor.visit_i32_msload8_s(self.read_memarg(0)?),
            0xe6 => visitor.visit_i32_msload8_u(self.read_memarg(0)?),
            0xe7 => visitor.visit_i32_msload16_s(self.read_memarg(1)?),
            0xe8 => visitor.visit_i32_msload16_u(self.read_memarg(1)?),
            0xe9 => visitor.visit_i64_msload8_s(self.read_memarg(0)?),
            0xea => visitor.visit_i64_msload8_u(self.read_memarg(0)?),
            ...
            0xf2 => visitor.visit_f32_msstore(self.read_memarg(2)?),
            0xf3 => visitor.visit_f64_msstore(self.read_memarg(3)?),
            0xf4 => visitor.visit_memref_msstore(self.read_memarg(2)?),
            0xf5 => visitor.visit_i32_msstore8(self.read_memarg(0)?),
            0xf6 => visitor.visit_i32_msstore16(self.read_memarg(1)?),
            0xf7 => visitor.visit_i64_msstore8(self.read_memarg(0)?),
            0xf8 => visitor.visit_i64_msstore16(self.read_memarg(1)?),
            0xf9 => visitor.visit_i64_msstore32(self.read_memarg(2)?),
